...
| GGML_SYCL_MAX_WG_PER_CU | Integer 1-1024 (16 default) | Set the flash-attention resident work-group cap per compute unit. Invalid values are ignored with a warning. |
